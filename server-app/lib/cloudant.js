...
//   })
var cloudant = new Cloudant({
    url: 'https://2df0032e-72d0-4301-a663-9dd3025c179e-bluemix.cloudantnosqldb.appdomain.cloud',
    plugins: {
        iamauth: { iamApiKey: 'yDFdT94AJtAMq6yXO7A7EVIqMUvqZe5WrTUo1a_iYXdP' }
    }
});
...
//        url: "https://51a2abe6-6cc0-4f34-aed0-e6f11e998335-bluemix.cloudantnosqldb.appdomain.cloud", 
//        maxAttempt: 5, 
//        plugins: [ { 
//            iamauth: { iamApiKey: 'A1XPgo7MTKp7bAxjxiQZNnK_ygKJpKICdnHqhAVrhIPF' } }, 
//            { retry: { retryDelayMultiplier: 4 } } ]});

// // Connect to users db
// var mydb = cloudant.db.use('restaurants');
...
// mydb.get('842675152c03f1c62672424ec2001e1d', function(err, data){
//     if (err){
//         console.log(err);
//     }
//     if (data){
